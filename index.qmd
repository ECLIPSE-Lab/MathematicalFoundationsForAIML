...
**Cancelled** — no MFML lecture takes place on 25.05.2026 (Pfingstmontag public holiday), and the week's exercise is cancelled too. Week 7's planned content (generalization, bias–variance, regularization & tree ensembles) moves to Week 8 (01.06.2026), and every later unit shifts one week later. The closing *Explainability, Limits & Scientific Trust* unit becomes optional reading (listed at the end of the schedule).
:::

## Week 8 Summary: Generalization, Bias-Variance, Regularization, Tree Ensembles
...
## Week 9 Summary: Probabilistic View of Learning; Noise
